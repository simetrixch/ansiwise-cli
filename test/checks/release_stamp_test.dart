...
/// `lib/release_stamp.dart` is generated and TRACKED, like `lib/plugins.dart` and
/// `lib/service_unit.dart` beside it — but unlike those two its content depends on the environment
/// a build ran in. A stamped copy committed by accident is not a stale file: it is every later
    ...
    test('is there, because the compiler reads it and not the environment', () {
      expect(
        ...
        reason:
            ...
            'and lib/service_unit.dart beside it. Absent, nothing in lib/ compiles',
      );
    });
