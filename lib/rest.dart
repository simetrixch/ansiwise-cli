...
///
/// The surface has ONE door, and it is a program of the executable that serves it: `serve`, which
/// speaks over the pipes of an SSH session sshd has already authenticated. Nothing in here binds an
/// address or carries a credential, because a machine is reached over the session a manager already
/// holds.
///
/// This file exists because two different callers reach the same set of types: the serving
/// executable and the suites under `test/rest/`. Without it each of them names ten files.
library;
